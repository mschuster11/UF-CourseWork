...
; Description:  Use the switches to control the RGB LED.
...
init:
    ...
    sts PORTD_DIRSET, initVal     ; Set PORTC to be output.
	ldi initVal, BLACK
	sts PORTD_OUT, initVal
    rjmp main                     
                      
main:                     
    lds switchValues, PORTA_IN    ; Load the switch's value into the 'switchValues'.
	ror switchValues
    sts PORTD_OUT, switchValues   ; Load 'switchValues' into the output to the LEDs.
